...
//            param.put("syrbm", "西山居");
            ...
            String path = "http://koq.kingsoft.cn/remoteapi/xsj/getGrdzsbTycx?token=2f3c6be59fd34d4fa221b4324a2b4eaf";
            HttpPost post = new HttpPost(path);

            String encrypt = encrypt(param.toString(), "5xUy29dHeKOPWJ32", "5xUy29dHeKOPWJ32");
            System.out.println(encrypt);
            StringEntity entity = new StringEntity(encrypt, "UTF-8");
            ...
            String decrypt = decrypt(result, "5xUy29dHeKOPWJ32", "5xUy29dHeKOPWJ32");
            JSONObject koaRes = JSONObject.parseObject(decrypt);
            JSONArray data = koaRes.getJSONArray("data");
            System.out.println("服务器端响应的数据：" + decrypt);
...
//		param.put("pagenow", 1);
            ...
            HttpClient client = new DefaultHttpClient();
            //String path = "http://koq.kingsoft.cn/remoteapi/xsj/getIdcGlycx?token=feb59dc2ebbf4ba798284efd1435956e";
            String path = "http://koq.kingsoft.cn/remoteapi/xsj/getZclb?token=153a551eaa4947508d6e78ac7e9f4eb7";
            HttpPost post = new HttpPost(path);
...
//		post.setEntity(entity);
    ...
    public static void testZczt() {
        try {
            HttpClient client = new DefaultHttpClient();
            String path = "http://koq.kingsoft.cn/remoteapi/xsj/getZczt?token=90e140f5043e4f71ae47220fa08f8b65";
            HttpPost post = new HttpPost(path);
